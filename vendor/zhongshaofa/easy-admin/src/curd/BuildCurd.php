...
class BuildCurd
{
    ...
    protected function buildViewJsUrl()
    {
        ...
        $this->controllerNamespace = empty($namespaceSuffix) ? "app\gladmin\controller" : "app\gladmin\controller\\{$namespaceSuffix}";
    ...
    protected function renderController()
    {
        ...
        $controllerValue = CommonTool::replaceTemplate(
            ...
            [
                ...
                'modelFilename'        => "\app\gladmin\model\\{$modelFilenameExtend}",
    ...
    protected function renderModel()
    {
            ...
            foreach ($this->relationArray as $key => $val) {
                ...
                $relationCode = CommonTool::replaceTemplate(
                    ...
                    [
                        ...
                        'relationModel'  => "\app\gladmin\model\\{$val['modelFilename']}",
        ...
        $modelValue = CommonTool::replaceTemplate(
            ...
            [
                ...
                'modelNamespace' => "app\gladmin\model{$extendNamespace}",
                'table'          => $this->table,
