        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'uid', minWidth: 0, title: '用户ID',searchOp: '='},
                    {field: 'username', minWidth: 0, title: '用户名',search: false,},
                    {field: 'name', minWidth: 0, title: '购买产品'},
                    {field: 'is_first', minWidth: 0, title: '是否首单', search: 'select', selectList: {0: '否', 1: '<span style="color:green">是</span>'}},
                    ...
                    {field: 'pay_type_name', Width: 0, title: '支付方式', sort:true,search: false},
                    ...
                    {field: 'order_num', Width: 0, title: '订单号', sort:true,searchOp: '='},
                    {
                        minWidth: 120,
                        title: '操作',
