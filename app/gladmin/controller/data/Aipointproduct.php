...
use app\common\model\AiPointsProduct as AiPointProductModel;
 ...
 * @ControllerAnnotation(title="ai点数管理")
 */
class Aipointproduct extends AdminController
{
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new AiPointProductModel();
    }
    /**
