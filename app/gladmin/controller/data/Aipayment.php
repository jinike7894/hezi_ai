...
use app\common\model\AiPayment as  AiPaymentModel;
 ...
 * @ControllerAnnotation(title="ai支付渠道管理")
 */
class Aipayment extends AdminController
{
