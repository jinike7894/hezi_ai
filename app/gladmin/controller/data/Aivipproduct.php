...
use app\common\model\AiVipProduct as AiVipProductModel;
 ...
 * @ControllerAnnotation(title="ai产品管理")
 */
class Aivipproduct extends AdminController
{
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new AiVipProductModel();
    }
    /**
