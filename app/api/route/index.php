...
//换一批
Route::get('video/loadNewBatch','Video/loadNewBatch');
//查看更多
Route::get('video/videoByCid','Video/videoByCid');
//新货
Route::get('video/newVideoList','Video/newVideoList');
//获取分类视频列表
Route::get('video/cateVideoList','Video/cateVideoList');
//获取筛选分类视频列表
Route::get('video/filter','Video/filter');
//获取视频详情
