...
class AiBase extends BaseController
{
    ...
    public function initialize(){
        ...
        if ($action != 'registerUser'&&$action != "loginByPasswd"&&$action != "customerService"&&$action != "payNotify"&&$action != "getTaskStatus"&&$action != "videoTemplateData"&&$action != "videoTemplateFindData") {
           // 获取请求头中的 token
