...
namespace app\common\extend\ipLocation;

use app\common\extend\ipLocation\IpParser\QQwry;
use app\common\extend\ipLocation\IpParser\IpV6wry;
...
class IpLocation {
    ...
    private static function getIpV4Path() {
        return self::$ipV4Path ? : self::root('/libs/qqwry.dat');
    }
    ...
    private static function getIpV6Path() {
        return self::$ipV6Path ? : self::root('/libs/ipv6wry.db');
    }
