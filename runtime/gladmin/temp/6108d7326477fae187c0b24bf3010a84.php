<?php /*a:2:{s:60:"/www/wwwroot/daohang/view/gladmin/data/channelcodes/add.html";i:1685515336;s:53:"/www/wwwroot/daohang/view/gladmin/layout/default.html";i:1679848387;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                 <select name="uid" lay-verify="required" data-select="<?php echo url('data.users/index'); ?>" data-fields="id,username" data-value="<?php echo htmlentities((isset($row['id']) && ($row['id'] !== '')?$row['id']:'')); ?>">
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="channelCode" class="layui-input" lay-verify="required" placeholder="请输入渠道号,不能重复" value="" step="1" />
            </div>
        </div>
