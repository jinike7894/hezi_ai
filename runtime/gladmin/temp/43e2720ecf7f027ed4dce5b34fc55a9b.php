<?php /*a:2:{s:64:"/www/wwwroot/532rzp.com/view/gladmin/data/channelcodes/edit.html";i:1714500804;s:56:"/www/wwwroot/532rzp.com/view/gladmin/layout/default.html";i:1679848388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                 <select name="uid" lay-verify="" data-select="<?php echo url('data.users/index'); ?>" data-fields="id,username" data-value="<?php echo htmlentities((isset($row['uid']) && ($row['uid'] !== '')?$row['uid']:'')); ?>">
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label required">51la统计</label>
            <div class="layui-input-block">
                <input type="text" name="51la_code" class="layui-input"  placeholder="请输入51la统计" value="<?php echo htmlentities((isset($row['51la_code']) && ($row['51la_code'] !== '')?$row['51la_code']:'')); ?>"  />
            <tip>51la统计</tip>
            </div>
        </div>
        
        <div class="layui-form-item">
            <label class="layui-form-label required">cnzz统计</label>
            <div class="layui-input-block">
                <input type="text" name="cnzz_code" class="layui-input"  placeholder="请输入cnzz统计" value="<?php echo htmlentities((isset($row['cnzz_code']) && ($row['cnzz_code'] !== '')?$row['cnzz_code']:'')); ?>"  />
            <tip>cnzz统计</tip>
            </div>
        </div>
