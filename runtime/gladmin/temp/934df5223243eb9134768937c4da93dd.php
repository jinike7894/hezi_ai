<?php /*a:5:{s:59:"/www/wwwroot/redlight/view/gladmin/system/config/index.html";i:1643556692;s:54:"/www/wwwroot/redlight/view/gladmin/layout/default.html";i:1679848388;s:58:"/www/wwwroot/redlight/view/gladmin/system/config/site.html";i:1662623602;s:58:"/www/wwwroot/redlight/view/gladmin/system/config/logo.html";i:1643556692;s:60:"/www/wwwroot/redlight/view/gladmin/system/config/upload.html";i:1643556692;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layuimini-container">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="tg_url" class="layui-input" lay-verify="required" placeholder="请输入推广域名" value="<?php echo sysconfig('site','tg_url'); ?>">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="pic_url" class="layui-input" lay-verify="required" placeholder="请输入图片域名" value="<?php echo sysconfig('site','pic_url'); ?>">
