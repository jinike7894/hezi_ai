<?php /*a:2:{s:58:"/www/wwwroot/532rzp.com/view/gladmin/data/product/add.html";i:1696232138;s:56:"/www/wwwroot/532rzp.com/view/gladmin/layout/default.html";i:1679848388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="pid" lay-verify="required" data-select="<?php echo url('data.type/index'); ?>" data-fields="id,title"></select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="cid" lay-verify="required" data-select="<?php echo url('data.category/index'); ?>" data-fields="id,title"></select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="sort" class="layui-input" lay-verify="required" placeholder="请输入产品所在位置" value="1" size="10">
            </div>
        </div>
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <textarea name="name" class="layui-textarea" lay-verify="required" placeholder="请输入广告位名称,匹配城市请用{city}占位"></textarea>
            </div>
        </div>
            ...
            <div class="layui-input-block">
                <input type="text" name="k_name" class="layui-input" lay-verify="required" placeholder="请输入客户名称" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="img" class="layui-input layui-col-xs6" lay-verify="required" placeholder="请上传产品图片" value="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="is_browser" id="is_browser">
                    <option value="0">内部浏览器</option>
                    <option value="1" selected="selected">外部浏览器</option>
                    <option value="2">打开播放器</option>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="pics" class="layui-input layui-col-xs6" lay-verify="required" placeholder="请上传产品详细图片(3~6张)" value="">
                <div class="layuimini-upload-btn">
