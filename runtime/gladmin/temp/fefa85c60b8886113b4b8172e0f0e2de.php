<?php /*a:2:{s:59:"/www/wwwroot/532rzp.com/view/gladmin/data/product/copy.html";i:1696233378;s:56:"/www/wwwroot/532rzp.com/view/gladmin/layout/default.html";i:1679848388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="cid" lay-verify="required" data-select="<?php echo url('data.category/index'); ?>" data-fields="id,title" data-value="<?php echo htmlentities((isset($row['cid']) && ($row['cid'] !== '')?$row['cid']:'')); ?>"></select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="is_browser" id="is_browser">
                    ...
                    <option value="2" <?php if($row['is_browser'] == 2): ?>selected<?php endif; ?>>打开播放器</option>
                </select>
            </div>
        </div>
