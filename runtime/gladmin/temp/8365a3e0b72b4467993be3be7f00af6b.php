<?php /*a:2:{s:55:"/www/wwwroot/h5/view/gladmin/data/channelcodes/add.html";i:1733470589;s:48:"/www/wwwroot/h5/view/gladmin/layout/default.html";i:1679848388;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <!-- <select name="uid" lay-verify="" data-select="<?php echo url('data.users/index'); ?>" data-fields="id,username" data-value="<?php echo htmlentities((isset($row['id']) && ($row['id'] !== '')?$row['id']:'')); ?>">-->
                <!--</select>-->
                  <input type="text" name="username" class="layui-input" lay-verify="required" placeholder="密码为123456" value=""  />
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="51la_code" class="layui-input"  placeholder="请输入51la统计"  />
            <tip>51la统计</tip>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="cnzz_code" class="layui-input"  placeholder="请输入cnzz统计"  />
            <tip>cnzz统计</tip>
            </div>
        </div>
